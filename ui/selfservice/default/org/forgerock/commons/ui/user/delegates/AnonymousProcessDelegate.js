...
define("org/forgerock/commons/ui/user/delegates/AnonymousProcessDelegate", ["jquery", "underscore", "org/forgerock/commons/ui/common/main/AbstractDelegate", "org/forgerock/commons/ui/common/util/Constants"], function ($, _, AbstractDelegate, Constants) {

    var AnonymousProcessDelegate = function AnonymousProcessDelegate(path, token) {
        this.token = token;
