...
define("org/forgerock/commons/ui/user/profile/UserProfileKBAView", ["jquery", "lodash", "form2js", "js2form", "handlebars", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/main/Configuration", "KBADelegate", "org/forgerock/commons/ui/user/profile/UserProfileView", "org/forgerock/commons/ui/common/main/ValidatorsManager"], function ($, _, form2js, js2form, Handlebars, AbstractView, Configuration, KBADelegate, UserProfileView, ValidatorsManager) {
    ...
    var UserProfileKBAView = AbstractView.extend({
        ...
        partials: UserProfileView.partials.concat(["partials/profile/_kbaTab.html", "partials/profile/_kbaItem.html"]),
        ...
        submit: function submit(formId, formData) {
            if (formId === "KBA") {
        ...
        getFormContent: function getFormContent(form) {
            if (form.id === "KBA") {
        ...
        render: function render(args, callback) {
            ...
            KBADelegate.getInfo().then(function (response) {
                ...
                UserProfileView.render.call(self, args, function () {
                    self.$el.find("#kbaDescription").text($.t("common.user.kba.description", { numberOfQuestions: response.minimumAnswersToDefine }));
        ...
        parentRender: function parentRender(callback) {
            UserProfileView.parentRender.call(this, function () {
                ...
                this.$el.find(".nav-tabs").append($('<li>').append($('<a href="#userKBATab" role="tab" data-toggle="tab">').text($.t("common.user.kba.securityQuestions"))));
                _.bind(callback, this)();
            });
        },
        reloadFormData: function reloadFormData(form) {
            var newContent;
