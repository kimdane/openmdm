...
define("org/forgerock/commons/ui/user/anonymousProcess/AnonymousProcessView", ["jquery", "underscore", "form2js", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/user/delegates/AnonymousProcessDelegate", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/main/Router", "org/forgerock/commons/ui/common/util/UIUtils", "org/forgerock/commons/ui/common/main/ValidatorsManager"], function ($, _, form2js, AbstractView, AnonymousProcessDelegate, Constants, EventManager, Router, UIUtils, ValidatorsManager) {
    ...
    var AnonymousProcessView = AbstractView.extend({
        ...
        setDelegate: function setDelegate(endpoint, token) {
        ...
        renderProcessState: function renderProcessState(response) {
            var processStatePromise = $.Deferred(),
                ...
                loadGenericTemplate = function loadGenericTemplate(stateData) {
                UIUtils.fillTemplateWithData(baseTemplateUrl + (_.has(response, "requirements") ? "GenericInputForm.html" : "GenericEndPage.html"), stateData, processStatePromise.resolve);
            },
                attemptCustomTemplate = _.bind(function (stateData) {
                UIUtils.compileTemplate(baseTemplateUrl + this.processType + "/" + response.type + "-" + response.tag + ".html", stateData).then(function (renderedTemplate) {
