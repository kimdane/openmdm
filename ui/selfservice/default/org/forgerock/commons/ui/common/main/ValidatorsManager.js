...
define("org/forgerock/commons/ui/common/main/ValidatorsManager", ["jquery", "underscore", "org/forgerock/commons/ui/common/main/AbstractConfigurationAware", "org/forgerock/commons/ui/common/util/ModuleLoader"], function ($, _, AbstractConfigurationAware, ModuleLoader) {
    /**
    ...
    */
    obj.evaluateDependentFields = function (element, container) {
        ...
        if (dependentFields) {
            return $.when.apply($, container.find(':input').filter(function () {
