...
define("org/forgerock/commons/ui/common/main/AbstractCollection", ["jquery", "underscore", "backbone", "backbone.paginator", "org/forgerock/commons/ui/common/main/AbstractModel", "org/forgerock/commons/ui/common/main/ServiceInvoker", "org/forgerock/commons/ui/common/components/Messages"], function ($, _, Backbone, BackbonePaginator, AbstractModel, ServiceInvoker, Messages) {
    /**
    ...
    return BackbonePaginator.extend({
        ...
        */
        ...
        hasNext: function hasNext() {
            return this.getPagingType() === "cookie" && this.state.pagedResultsCookie !== null || this.getPagingType() === "offset" && this.state.totalRecords === null || // when we don't have a total, assume there are more results
