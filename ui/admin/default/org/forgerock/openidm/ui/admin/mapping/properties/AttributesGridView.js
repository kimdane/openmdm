...
define("org/forgerock/openidm/ui/admin/mapping/properties/AttributesGridView", ["jquery", "underscore", "handlebars", "backbone", "org/forgerock/openidm/ui/admin/mapping/util/MappingAdminAbstractView", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/openidm/ui/admin/delegates/ConnectorDelegate", "org/forgerock/openidm/ui/common/delegates/ConfigDelegate", "org/forgerock/openidm/ui/admin/mapping/util/MappingUtils", "org/forgerock/openidm/ui/admin/util/LinkQualifierUtils", "org/forgerock/openidm/ui/admin/delegates/ScriptDelegate", "org/forgerock/openidm/ui/admin/util/FilterEvaluator", "org/forgerock/openidm/ui/admin/mapping/util/QueryFilterEditor", "org/forgerock/openidm/ui/admin/mapping/properties/AddPropertyMappingDialog", "org/forgerock/openidm/ui/admin/mapping/properties/EditPropertyMappingDialog", "backgrid", "org/forgerock/openidm/ui/admin/util/BackgridUtils", "org/forgerock/commons/ui/common/util/UIUtils", "org/forgerock/openidm/ui/admin/util/AdminUtils"], function ($, _, Handlebars, Backbone, MappingAdminAbstractView, eventManager, conf, constants, connectorDelegate, configDelegate, mappingUtils, LinkQualifierUtil, ScriptDelegate, FilterEvaluator, QueryFilterEditor, AddPropertyMappingDialog, EditPropertyMappingDialog, Backgrid, BackgridUtils, UIUtils, AdminUtils) {
    ...
    var AttributesGridView = MappingAdminAbstractView.extend({
        ...
        */
        ...
        checkAvailableProperties: function checkAvailableProperties() {
            var availableProps;
        ...
        buildAvailableObjectsMap: function buildAvailableObjectsMap() {
