...
define("org/forgerock/openidm/ui/admin/settings/audit/AuditEventHandlersDialog", ["jquery", "underscore", "org/forgerock/openidm/ui/admin/settings/audit/AuditAdminAbstractView", "org/forgerock/openidm/ui/admin/delegates/AuditDelegate", "org/forgerock/commons/ui/common/util/UIUtils", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/openidm/ui/admin/util/InlineScriptEditor", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/ValidatorsManager", "bootstrap-dialog", "jsonEditor", "bootstrap-tabdrop", "selectize"], function ($, _, AuditAdminAbstractView, AuditDelegate, uiUtils, conf, InlineScriptEditor, constants, ValidatorsManager, BootstrapDialog, JSONEditor) {
        ...
        renderTemplate: function renderTemplate(data) {
            uiUtils.renderTemplate(this.template, this.$el, _.extend({}, conf.globalData, data), _.bind(function (data) {
                ...
                if (!_.isEmpty(schema)) {
                    ...
                    if (_.has(schema, "properties.security.properties.signatureInterval") && _.has(this.data.eventHandler, "config") && (!_.has(this.data.eventHandler.config, "security.signatureInterval") || !this.data.eventHandler.config.security.signatureInterval)) {
