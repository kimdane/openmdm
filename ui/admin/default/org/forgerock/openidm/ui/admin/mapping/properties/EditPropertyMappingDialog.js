...
define("org/forgerock/openidm/ui/admin/mapping/properties/EditPropertyMappingDialog", ["jquery", "underscore", "form2js", "org/forgerock/openidm/ui/admin/mapping/util/MappingAdminAbstractView", "org/forgerock/openidm/ui/admin/delegates/SyncDelegate", "org/forgerock/commons/ui/common/main/ValidatorsManager", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/commons/ui/common/util/UIUtils", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/SpinnerManager", "org/forgerock/openidm/ui/admin/util/InlineScriptEditor", "org/forgerock/openidm/ui/admin/mapping/util/LinkQualifierFilterEditor", "org/forgerock/openidm/ui/admin/util/AdminUtils", "bootstrap-dialog", "bootstrap-tabdrop", "selectize"], function ($, _, form2js, MappingAdminAbstractView, syncDelegate, validatorsManager, conf, uiUtils, eventManager, constants, spinner, inlineScriptEditor, LinkQualifierFilterEditor, AdminUtils, BootstrapDialog, tabdrop, selectize) {
    ...
    var EditPropertyMappingDialog = MappingAdminAbstractView.extend({
        ...
        render: function render(params, callback) {
            var currentProperties, sourceType;
        ...
        renderEditProperty: function renderEditProperty(callback) {
            var _this = this,
                settings;
