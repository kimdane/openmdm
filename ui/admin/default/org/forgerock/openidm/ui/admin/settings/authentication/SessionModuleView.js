...
define("org/forgerock/openidm/ui/admin/settings/authentication/SessionModuleView", ["jquery", "underscore", "org/forgerock/openidm/ui/admin/settings/authentication/AuthenticationAbstractView", "org/forgerock/commons/ui/common/components/ChangesPending"], function ($, _, AuthenticationAbstractView, ChangesPending) {
    ...
    var SessionModuleView = AuthenticationAbstractView.extend({
        ...
        render: function render(configs, callback) {
            ...
            }, configs, this.getAuthenticationData());
            ...
            if (this.model.hasAM && this.data.maxTokenLife === this.model.defaults.maxTokenLife && this.data.maxTokenLifeMinutes === this.model.defaults.maxTokenLifeMinutes && this.data.tokenIdleTime === this.model.defaults.tokenIdleTime && this.data.tokenIdleTimeMinutes === this.model.defaults.tokenIdleTimeMinutes) {
