...
define("org/forgerock/openidm/ui/admin/settings/authentication/AuthenticationModuleView", ["jquery", "underscore", "backbone", "backgrid", "handlebars", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/openidm/ui/admin/settings/authentication/AuthenticationAbstractView", "org/forgerock/openidm/ui/admin/settings/authentication/AuthenticationModuleDialogView", "org/forgerock/openidm/ui/admin/util/BackgridUtils", "org/forgerock/commons/ui/common/components/ChangesPending"], function ($, _, Backbone, Backgrid, Handlebars, Configuration, AuthenticationAbstractView, AuthenticationModuleDialogView, BackgridUtils, ChangesPending) {
    ...
    var AuthenticationModuleView = AuthenticationAbstractView.extend({
        ...
        partials: ["partials/settings/_authenticationModuleRow.html"],
        data: {
            module_types: {
                "STATIC_USER": null,
                "CLIENT_CERT": null,
            ...
            amUIProperties: ["openamLoginUrl", "openamLoginLinkText", "openamUseExclusively"],
         ...
         */
        checkHasAM: function checkHasAM() {
        ...
        handleOpenAMUISettings: function handleOpenAMUISettings(config) {
            var prom = $.Deferred(),
                amAuthIndex,
                amSettings;
        ...
        addOpenAMUISettings: function addOpenAMUISettings() {
            var amAuthIndex = _.findIndex(this.model.authModules, { name: "OPENAM_SESSION" });

            if (!this.model.changes && amAuthIndex >= 0) {
                //add amUIProperties
                this.model.authModules[amAuthIndex].properties = _.extend(this.model.authModules[amAuthIndex].properties, _.pick(Configuration.globalData, this.data.amUIProperties));
            }
        }
