...
define("org/forgerock/openidm/ui/admin/selfservice/AbstractSelfServiceView", ["jquery", "underscore", "bootstrap", "handlebars", "form2js", "org/forgerock/openidm/ui/admin/util/AdminAbstractView", "org/forgerock/openidm/ui/common/delegates/ConfigDelegate", "org/forgerock/openidm/ui/admin/delegates/SiteConfigurationDelegate", "org/forgerock/commons/ui/common/util/UIUtils", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/Constants", "bootstrap-dialog", "selectize", "org/forgerock/commons/ui/common/util/AutoScroll", "dragula"], function ($, _, bootstrap, handlebars, form2js, AdminAbstractView, ConfigDelegate, SiteConfigurationDelegate, UiUtils, EventManager, Constants, BootstrapDialog, selectize, AutoScroll, dragula) {
    ...
    var AbstractSelfServiceView = AdminAbstractView.extend({
        ...
        partials: ["partials/selfservice/_translationMap.html", "partials/selfservice/_translationItem.html", "partials/selfservice/_advancedoptions.html", "partials/selfservice/_selfserviceblock.html", "partials/form/_basicInput.html"],
        data: {
            hideAdvanced: true,
            config: {},
            configList: []
        ...
        addTranslation: function addTranslation(e) {
            ...
            if (!_.has(currentStageConfig[field][locale.val()])) {
                ...
                translationMapGroup.find("ul").append(handlebars.compile("{{> selfservice/_translationItem}}")({
                    locale: locale.val(),
                    text: text.val()
                }));
                text.val("");
