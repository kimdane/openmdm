...
define("org/forgerock/openidm/ui/admin/connector/ldap/LDAPTypeView", ["jquery", "underscore", "org/forgerock/openidm/ui/admin/connector/ConnectorTypeAbstractView", "org/forgerock/commons/ui/common/main/ValidatorsManager", "org/forgerock/openidm/ui/admin/connector/ldap/LDAPFilterDialog", "org/forgerock/openidm/ui/admin/delegates/ConnectorDelegate", "org/forgerock/commons/ui/common/util/UIUtils", "org/forgerock/openidm/ui/admin/delegates/SecurityDelegate", "bootstrap-dialog"], function ($, _, ConnectorTypeAbstractView, validatorsManager, ldapFilterDialog, ConnectorDelegate, uiUtils, securityDelegate, BootstrapDialog) {
    ...
    var LDAPTypeView = ConnectorTypeAbstractView.extend({
            ...
            BootstrapDialog.show({
                ...
                onshown: function onshown(dialogRef) {
                    var saveBtn = dialogRef.$modalFooter.find("#sslSaveButton"),
                        ...
                        updateBtnStatus = function updateBtnStatus() {
        ...
        connectorValidate: function connectorValidate(callback, details) {
        ...
        connectorSaved: function connectorSaved(details) {
            if (this.$el.find("#syncBaseContext").is(":checked")) {
                details.configurationProperties.baseContextsToSynchronize = details.configurationProperties.baseContexts;
            }
