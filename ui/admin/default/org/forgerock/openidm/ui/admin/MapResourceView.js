...
define("org/forgerock/openidm/ui/admin/MapResourceView", ["jquery", "underscore", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/Router", "org/forgerock/openidm/ui/common/delegates/ConfigDelegate", "bootstrap-dialog"], function ($, _, AbstractView, eventManager, constants, router, ConfigDelegate, BootstrapDialog) {
    var MapResourceView = AbstractView.extend({
        ...
        createMappingName: function createMappingName() {
            var targetName = "",
                sourceName = "",
                tempName,
                tempObjectType;
