...
define("org/forgerock/openidm/ui/admin/settings/update/RepoUpdateView", ["jquery", "underscore", "handlebars", "backgrid", "backbone", "org/forgerock/openidm/ui/admin/util/AdminAbstractView", "org/forgerock/openidm/ui/admin/util/BackgridUtils", "org/forgerock/openidm/ui/admin/delegates/MaintenanceDelegate"], function ($, _, Handlebars, Backgrid, Backbone, AdminAbstractView, BackgridUtils, MaintenanceDelegate) {
    var RepoUpdatesView = AdminAbstractView.extend({
        ...
        getRepoUpdate: function getRepoUpdate() {
            var repoUpdates = new Backbone.Collection();

            _.each(this.repoUpdatesList, _.bind(function (repoUpdate) {

                MaintenanceDelegate.getUpdateFile(this.archiveName, repoUpdate.path).then(_.bind(function (data) {
