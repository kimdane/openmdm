...
define("org/forgerock/openidm/ui/admin/dashboard/Dashboard", ["jquery", "underscore", "bootstrap-dialog", "handlebars", "org/forgerock/openidm/ui/admin/util/AdminAbstractView", "org/forgerock/openidm/ui/admin/dashboard/DashboardWidgetLoader", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/commons/ui/common/main/Router", "org/forgerock/openidm/ui/common/delegates/ConfigDelegate", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/ValidatorsManager", "org/forgerock/openidm/ui/admin/delegates/SiteConfigurationDelegate", "org/forgerock/commons/ui/common/util/UIUtils", "org/forgerock/commons/ui/common/util/AutoScroll", "dragula"], function ($, _, BootstrapDialog, Handlebars, AdminAbstractView, DashboardWidgetLoader, Configuration, Router, ConfigDelegate, EventManager, Constants, ValidatorsManager, SiteConfigurationDelegate, UIUtils, AutoScroll, dragula) {
    ...
    var DashboardView = AdminAbstractView.extend({
        ...
        defaultDashboard: function defaultDashboard(e) {
            e.preventDefault();
        ...
        deleteDashboard: function deleteDashboard(e) {
            e.preventDefault();
