...
define("org/forgerock/openidm/ui/admin/delegates/ReconDelegate", ["jquery", "underscore", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/AbstractDelegate", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/main/SpinnerManager", "org/forgerock/commons/ui/common/main/Router"], function ($, _, constants, AbstractDelegate, configuration, eventManager, spinner, router) {
    ...
    obj.triggerRecon = function (mapping, suppressSpinner, progressCallback) {
        ...
        return obj.serviceCall({
            ...
            return obj.waitForAll([reconId._id], suppressSpinner, progressCallback).then(function (reconArray) {
                return reconArray[0];
            });
        });
    };
