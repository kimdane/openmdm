...
define("org/forgerock/openidm/ui/common/UserModel", ["jquery", "underscore", "org/forgerock/commons/ui/common/main/AbstractModel", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/main/ServiceInvoker"], function ($, _, AbstractModel, Configuration, Constants, EventManager, ServiceInvoker) {
        ...
        getValidationRules: function getValidationRules() {
            if (!this.policy) {
                return ServiceInvoker.restCall({
                    ...
                    this.protectedAttributeList = _.chain(policyRules.properties).filter(function (propertyRule) {
