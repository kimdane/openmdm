...
define("config/process/CommonConfig", ["jquery", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/EventManager"], function ($, Constants, EventManager) {
    var obj = [{
        ...
        processDescription: function processDescription(event, Router, Configuration, UIUtils, CookieHelper, SessionManager, i18nManager) {
            var postSessionCheck = function postSessionCheck() {
                ...
                initLocalization = function initLocalization() {
                i18nManager.init({
        ...
        processDescription: function processDescription(error, Router, Configuration, SessionManager) {
        ...
        processDescription: function processDescription(error, router) {
