...
switch (objectClass) {
    case ObjectClass.ACCOUNT:
        ...
        builder {
            ...
            departmentCode(createAttributes.hasAttribute("departmentCode") ? createAttributes.findString("departmentCode") : "")
            divisionName(createAttributes.hasAttribute("divisionName") ? createAttributes.findString("divisionName") : "")
        }
        ...
        connection.put(
                path: "/api/${apiVersion}/contact-persons/${name}",
