...
log.info("This is Scripted CREST TestScript")

def objectClass = ObjectClass.ACCOUNT;
...
if (objectClassInfo != null) {
    ...
    request.setResourcePath("/openidm/managed/user")

    request.queryFilter = QueryFilter.equalTo("userName", "ino")
    ...
    if (results.empty) {
        throw new UnknownUidException("Could not find userName 'ino' on external system!")
		...
		log.info("This is ExternalIDM TestScript: System is up!")
